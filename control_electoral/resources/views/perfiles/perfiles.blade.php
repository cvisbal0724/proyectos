      ...
      <div class="panel-body">
      	<div class="col-lg-6">
            ...
            <div class="alert alert-{{result.alert}} alert-dismissable" ng-show='result.show'>
			 ...
			 <button ng-if='perfilesVO.id==0' type="button" class="btn btn-primary" ng-click='guardar()'>Registrar</button>  
       <button ng-if='perfilesVO.id>0' type="button" class="btn btn-primary" ng-click='guardar()'>Actualizar</button>  
