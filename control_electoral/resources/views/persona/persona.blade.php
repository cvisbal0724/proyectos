       ...
       <div class="panel-body">
      	<div class="col-lg-6">
            ...
            <div class="form-group">
			 ...
			 <button ng-if='personaVO.id==0' type="button" class="btn btn-primary" ng-click='crear()'>Registrar</button>  
       <button ng-if='personaVO.id>0' type="button" class="btn btn-primary" ng-click='actualizar()'>Actualizar</button>  
