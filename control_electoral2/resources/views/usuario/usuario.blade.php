<div class="col-lg-12">
 <div class="form-panel">  
   ...
   Registrar Usuario
       ...
       <button ng-if='usuarioVO.id==0' type="button" class="btn btn-warning" ng-click='crear()'>Registrar</button>  
       <button ng-if='usuarioVO.id>0' type="button" class="btn btn-warning" ng-click='actualizar()'>Actualizar</button>  
