  ...
  <div class="modal fade bs-example-modal-sm" id="modalRegistrarGoogle" 
  tabindex="-1" role="dialog" ng-init='cargar_datos_google()' data-backdrop="static">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" aria-label="Close" ng-click='desloguear_google()'><span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-body">
            ...
            <form role="form" name="myForm">
                <fieldset>
                  ...
                  <h4 class="text-warning btn-block">Datos de google</h4>
          ...
          <div class="modal-footer">
           <button type="button" class="btn btn-default" ng-click='desloguear_google()'>Cerrar</button>
            <button type="button" class="btn btn-default btn-primary" ng-click='crearcuenta_con_google()'>Continuar</button>
          </div>
        </div>       
      </div>      
    </div>    
