                                    ...
                                    <tbody>
                                       <tr>
                                          <td align="left" style="padding-top:20px;padding-bottom:20px;padding-left:40px;padding-right:40px"><font face="Arial, sans-serif
                                            ...
                                            Hola, [[ $nombres ]],
                                             <br><br>
                                             Usted ha solicitado recordar su contraseña.
                                             <br><br>
                                            Para continuar y restablecer su contraseña haga clic en el siguiente botÓn:
                                             <br>
                                             ...
                                             <table border="0" cellspacing="0" cellpadding="0" bgcolor="#008a32">
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      <font face="'Walsheim-Medium', Arial, sans-serif" color="#ffffff" style="font-size:18px;line-height:20px">CLICK AQUI</font></a></td>
                                                   </tr>
                                                </tbody>
                                             </table>
                                          </td>
